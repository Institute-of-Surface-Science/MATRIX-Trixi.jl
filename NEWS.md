...
#### Added
- Added a short DGMulti pure-diffusion integration check on a Triangulate.jl mesh,
  including conversion of integer segment markers to symbolic Dirichlet and Neumann
  boundary names
