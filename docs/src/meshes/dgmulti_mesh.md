...
* [`examples/dgmulti_2d/elixir_diffusion_triangulate_pkg_mesh.jl`](https://github.com/trixi-framework/Trixi.jl/blob/main/examples/dgmulti_2d/elixir_diffusion_triangulate_pkg_mesh.jl):
  solves a purely parabolic equation on an unstructured triangular mesh generated with
  Triangulate.jl. Integer segment markers are mapped to symbolic boundary names and used to apply
  different Dirichlet and Neumann boundary conditions with a positive-penalty LDG formulation.
