...
@inline function exact_solution(x, t, equations::LinearDiffusionEquation2D)
    transient_x = diffused_sine_power(x[1], t, equations.diffusivity)
    transient_y = diffused_sine_power(x[2], t, equations.diffusivity)
...
@inline flux_x_neg(x, t, equations) = SVector(-equations.diffusivity)
@inline flux_x_pos(x, t, equations) = SVector(equations.diffusivity)
